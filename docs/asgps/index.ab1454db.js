...
},{}],"jNUl6":[function(require,module,exports) {
/**
 * Canvas settings
 ...
 */ async function loadWasm() {
    const response = await fetch(new URL(require("b5ca459c6afce71d")));
 ...
 */ function convertRGB565toStyle(rgb565) {
    ...
    return `#` + `${Number(r8).toString(16).padStart(2, "0")}` + `${Number(g8).toString(16).padStart(2, "0")}` + `${Number(b8).toString(16).padStart(2, "0")}`;
}
...
},{"b5ca459c6afce71d":"iBpCa"}],"iBpCa":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("brDXR") + "gpsgsv.0a16a138.wasm" + "?" + Date.now();
...
},{}]},["ckVhm","jNUl6"], "jNUl6", "parcelRequirea94f")

//# sourceMappingURL=index.ab1454db.js.map
